/**
 * Resolve texto de citação para exibição a partir de armazenamento canônico + traduções.
 */

/**
 * @param {object} entry
 * @param {string} [entry.originalLanguage]
 * @param {string} [entry.quote_original]
 * @param {string} [entry.quote_en]
 * @param {string} [entry.quote_pt]
 * @param {string} [entry.quote] fallback legado
